...
export const Route = createFileRoute("/_authenticated/alunos")({
  head: () => ({
    meta: [
      { title: "Alunos por turma — Escola de Finanças" },
      {
        name: "description",
        content: "Lista de alunos da Escola de Finanças organizada por curso, turma e sala.",
      },
      { property: "og:title", content: "Alunos por turma — Escola de Finanças" },
